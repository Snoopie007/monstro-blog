...
These **Terms of Service** ("Terms" or "Agreement") is a contract between the Customer ("You" or "Your") and Monstro or 8BitApp LLC ("Us" or "We" or "Our").

We describe the services provided when you sign up for an account with Us, define aspects of our business relationship, and set forth the terms and conditions that apply to your access to and use of the websites, products, and services owned and operated by Us. Using our Subscription Services or signing up for Monstro indicates agreement with, and acceptance of, these Terms.
...
When you accept this Agreement, you are also agreeing to our [Privacy Policy](#). These Terms and our Privacy Policy may be amended at any time, with or without notice, so we recommend periodically reviewing them. Continued use of the Site and/or Services indicates acceptance of the latest version of each. We also suggest printing or saving a local copy of these Terms and the Privacy Policy for your records.
...
- **Account:**  
  An Account is created when an individual, company, or other entity, or any representative thereof, signs up to the Monstro platform with a username and password. Accounts may contain Content, Materials, pages, pop-ups, sticky bars, and other features Monstro may add from time to time. Accounts can either be free (called "Free Plans" or "Free Accounts") or paid Subscriptions.
  
- **Account Owner:**  
  The person, company, corporation, organization, or other entity whose name appears on the credit card that pays for the Monstro Subscription.
  
- **Advertisement Creatives and Copies:**  
  All Facebook, Google, Tiktok, or YouTube advertisements and templates (including copy + creatives) provided by Monstro.
  
- **Add-On:**  
  Customer sub-accounts, users, domains, and other features we may develop in the future that you have the option of adding to your Account based on Subscription level, which may or may not include an additional fee.
...
- **Beta Test:**  
  May include, but is not limited to, alterations to the Services, modifications to how the Services are offered or provided, and changes to the software; usually designed to test for bugs, usability issues, or to evaluate user experience.
  
- **Cancellation/Downgrade to Free:**  
  Removing subscription fees and paid features from an Account.
  
- **Claims:**  
  An assertion of entitlement to monetary, proprietary, or other judicially-enforceable redresses.
  
- **Commercial Electronic Messages:**  
  Emails containing newsletters, blogs, and other marketing materials.
  
- **Commercial Partners:**  
  A company with which Monstro has established a professional relationship via a partnership contract or other legally binding agreement(s).
  
- **Confidential Information:**  
  Any information marked confidential, identified as confidential at the time of disclosure, or that ought reasonably to be considered confidential, whether received in writing, visually, electronically, or orally. This includes, but is not limited to: technical information, marketing and business plans, databases, specifications, formulations, tooling, prototypes, sketches, models, drawings, procurement requirements, engineering information, samples, computer software (source and object codes), forecasts, details about actual or potential Customers or projects, techniques, inventions, discoveries, know-how, and trade secrets. It also includes all such business or technical information of any Third Party that is in Monstro’s possession.
  
- **Content:**  
  Includes (but is not limited to) text, images, logos, documents, HTML, Javascript, CSS, and other codes and intellectual property that are either open-source or owned by/ licensed to you, and that you have added to your Account.
  
- **Customer:**  
  Any person, organization, or other entity that has signed up for an Account, at any level.
  
- **Customer Goods:**  
  Products or services owned and sold by our Customers.
  
- **Feedback:**  
  Comments received orally, in writing, or electronically from current, past, or potential Customers. May include ideas, suggestions, concepts, processes, techniques, questions, answers, codes/scripts, etc., related to our Services, the Site, features, Customer Support, documentation, our business, affiliates, partners, licensors, or employees.
  
- **Funnels:**  
  All pre-installed funnel templates provided by Monstro, including but not limited to images, background images, and quizzes/surveys.
  
- **Hosted Site:**  
  Any website hosted by us for you as part of the Services.
  
- **Inactive User:**  
  A Monstro Account owner on a Free Plan/Free Account who has not logged in for twelve (12) months.
  
- **Indemnified Parties:**  
  Monstro, its subsidiaries, affiliates, co-branders, licensors, all third-party advertisers, technology providers, service providers, or other partners, and each of their respective officers, directors, agents, shareholders, employees, and representatives.
  
- **Lead:**  
  A potential customer who has provided their phone number and/or email.
  
- **Lead Capture Ratio:**  
  Percentage of leads captured from unique visitors to a website or Google Business Profile.
  
- **Licensors:**  
  Any company, individual, or other entity from which Monstro has licensed the use of its hardware, software, services, or other products and intellectual property.
  
- **Marketing Automation:**  
  All marketing, follow-up, and nurture automation templates provided by Monstro. These can be email, voicemail drop, or text message ("SMS") templates.
  
- **Materials:**  
  Anything provided by or through Monstro, its affiliates, subsidiaries, employees, agents, licensors, or other commercial partners, including (but not limited to) software, informational text, documentation, design (look and feel, layout), photographs, graphics, audio, video, messages, interactive and instant messaging, files, documents, images, or other materials, and all derivative works thereof.
  
- **Monitor/Monitoring:**  
  Oversight of Customer behavior (including usage of the Site and Services, and the Content added to Accounts), examination of traffic to specific pages, the functioning of the Site and Services, and other investigatory processes as needed.
  
- **Page Builder:**  
  Monstro’s page creation and editing platform for constructing your pages, popups, and sticky bars.
  
- **Personal Information/Personal Data:**  
  Any information (e.g., name, email, phone number, IP address) that can be used to identify a person.
  
- **Profile/Profile Information:**  
  All information in the "Your Profile" section of the application, including full name, email address, password, profile picture, newsletter preferences, and subscription level.
  
- **Providing Services:**  
  Access to and support for the Monstro platform, including the Page Builder, Page Overview, and other features available within each Subscription/Account level.
  
- **Sensitive Information:**  
  Credit or debit card numbers; personal financial information; Social Security/Social Insurance Numbers; passport numbers; driver's license numbers or similar identifiers; racial or ethnic origin; religious affiliation; sexual orientation; physical or mental health condition; biometric information; political affiliation; union membership; or other sensitive personal, employment, financial, or health information protected by applicable laws or industry standards.
  
- **Services:**  
  The Monstro platform/application and all its features, including but not limited to: the application program interface (API), lead collection, storage, transfer capabilities, and the ability to create, publish, and A/B test customizable landing pages, websites, pop-ups, and sticky bars.
  
- **Subscription:**  
  A Subscription to Monstro encompassing access to paid features.
  
- **Subscription Period:**  
  A thirty-day or annual period between billings.
  
- **Third Party:**  
  Any organization or person (other than you or Monstro). This includes, but is not limited to, CRM/CMS systems, email marketing software, billing and shopping cart/check-out platforms, PPC conversion tracking codes, analytics and other tracking software, non-Monstro forms, file hosting/sharing platforms, and any entities with which you or Monstro do business or integrate.
  
- **Trial Period:**  
  The period of a new Subscription, prior to billing, wherein you have access to paid features for 14 days. You agree not to create additional Accounts solely for obtaining additional Trial Periods.
  
- **Trial Program:**  
  A temporary release of a new feature that may later be added to a Subscription for an additional fee.
  
- **User ID:**  
  Your Monstro username and password (which may include the email address under which your Account was created).
  
- **Your Customers:**  
  Visitors who access your Monstro page(s) and may or may not purchase your products or services or complete your conversion goal. This Agreement does not apply to, or bind, any Third Party.
